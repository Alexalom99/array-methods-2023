...
result = flightReservations.filter(f => f.specialMeals.includes('Vegan'));

//result.forEach(f => console.log(f.airline));
...
result = flightReservations.map(f => {
...
result = flightReservations.reduce((sum, f )=> sum + f.loyaltyProgram.points,0);
